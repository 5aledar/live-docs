...
const ShareModel = ({ roomId, collaborators, creatorId, currentUserType }: ShareDocumentDialogProps) => {
    ...
    const shareDocumentHndler = async () => {
        setLoading(true)
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
                ...
                >
                    <Image
                        src={'/assets/icons/share.svg'} alt='share' width={20} height={20} className='min-w-4 md:size-5' />
            ...
            <DialogContent className='shad-dialog'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <Button
                        type='submit'
                        onClick={shareDocumentHndler} className='gradient-blue flex h-full gap-1 px-5'
                        disabled={loading}
                    >
